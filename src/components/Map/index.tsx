...
import { ButtonClose, Content, TitleCard } from "./styles";
import styles from "./styles.module.scss";

const infosMapa = {
  Amazonas: { state: "Na Amazonas", citys: ["MANAUS"] },
  Para: { state: "No Pará", citys: ["BELÉM"] },
  Bahia: {
    state: "Na Bahia",
    citys: ["CONCEIÇÃO DO ALMEIDA", "CANDEIAS"],
  },
  Pernambuco: {
    state: "Em Pernambuco",
    citys: ["RECIFE", "JABOATÃO DOS GUARARAPES", "OLINDA"],
  },
  RioGrandeDoNorte: { state: "No Rio Grande do Norte", citys: ["NATAL"] },
  Paraiba: { state: "Paraíba", citys: ["CAMPINA GRANDE"] },
  MinasGerais: {
    state: "Em Minas Gerais",
    citys: ["CARANDAÍ", "MANHUAÇU", "CONTAGEM", "PARAOPEBA", "IPUIUNA"],
  },
  RioDeJaneiro: {
    state: "No Rio de Janeiro",
    citys: [
      "RIO DE JANEIRO",
      "NITERÓI",
      "QUEIMADOS",
  ...
  Parana: { state: "No Paraná", citys: ["Curitiba"] },
  Goias: { state: "Em Goiás", citys: ["FORMOSA"] },
  MatoGrossoSul: { state: "Em Mato Grosso do Sul", citys: ["DOURADOS"] },
  SantaCatarina: {
    state: "Na Santa Catarina",
    citys: ["LAGES", "Florianópolis"],
  },
  RioGrandeDoSul: {
    state: "No Rio Grande do Sul",
    citys: ["CAXIAS DO SUL", "PELOTAS"],
  },
  Rondonia: { state: "Em Rondônia", citys: [""] },
};

export default function Mapa() {
  const [open, setOpen] = React.useState(false);
  const [stateSelect, setStateSelect] = React.useState<
    keyof typeof infosMapa | null
  >(null);
  const handleClose = () => {
    setOpen(false);
    setStateSelect(null);
  ...
  const selectState = (state: keyof typeof infosMapa) => {
    if (infosMapa.hasOwnProperty(state)) {
  ...
  return (
    <div className={styles.contenMapa}>
      <svg
        version="1.1"
        id="svg-map"
      ...
      >
        <g>
          ...
          <a
            data-toggle="modal"
            onClick={() => selectState("Pernambuco")}
            data-target="#Pernambuco"
          >
          ...
          <a
            data-toggle="modal"
            onClick={() => selectState("RioGrandeDoNorte")}
            data-target="#RioGrandeDoNorte"
          >
          ...
          <a
            data-toggle="modal"
            onClick={() => selectState("Amazonas")}
            data-target="#Amazonas"
          >
          ...
          <a
            data-toggle="modal"
            onClick={() => selectState("Rondonia")}
            data-target="#Rondonia"
          >
          ...
          <a
            data-toggle="modal"
            onClick={() => selectState("MatoGrossoSul")}
            data-target="#MatoGrossoSul"
          >
          ...
          <a
            data-toggle="modal"
            onClick={() => selectState("SantaCatarina")}
            data-target="#SantaCatarina"
          >
          ...
          <a
            data-toggle="modal"
            onClick={() => selectState("RioGrandeDoSul")}
            data-target="#RioGrandeDoSul"
          >
          ...
          <a
            data-toggle="modal"
            onClick={() => selectState("SaoPaulo")}
            data-target="#SaoPaulo"
          >
          ...
          <a
            data-toggle="modal"
            onClick={() => selectState("MinasGerais")}
            data-target="#MinasGerais"
          >
          ...
          <a
            data-toggle="modal"
            onClick={() => selectState("RioDeJaneiro")}
            data-target="#RioDeJaneiro"
          >
          ...
          <a>
            ...
            />
            <path
              className={`${styles["circle-desativo"]}`}
          ...
          <a
            data-toggle="modal"
            onClick={() => selectState("DistritoFederal")}
            data-target="#DistritoFederal"
          >
      ...
      <Dialog open={open} onClose={handleClose}>
        {stateSelect && (
          <>
            <TitleCard id="alert-dialog-title">
              {infosMapa[stateSelect].state}
            </TitleCard>
            <Content>
              <span>
                {infosMapa[stateSelect].state} a Rede Autoestima-se está na(s)
                seguinte(s) cidade(s):
              </span>
              <ul>
                {infosMapa[stateSelect].citys
